...
import ar.edu.uns.cs.trabajosocialform.Presentation.mvp.presenter.solicitantePresenter;
...
public class FormSolicitanteView extends GeneralActivity {
    ...
    protected void continuar(View view){
        ...
        if(validate(solicitante)){
            ...
            Intent intent = new Intent(this,FormApoderadoView.class);
            putExtras(intent);
