...
public class Familiar {
    ...
    public Familiar(int id, String nombres, String apellidos, String sexo, String nacion, Integer cuil, Date fecha_nacimiento, String estado_civil, String vinculo, String nucleo, String nivel_educativo, String capacitacion, int ocupacionId, int ingresoId, int saludId) {
        this.id = id;
